...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof incrmmaxabs, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an accumulator function', function test( t ) {
	t.equal( typeof incrmmaxabs( 3 ), 'function', 'returns a function' );
	t.end();
});
